...
Because each ECOSTRESS image has a slightly different grid, it is difficult to match the pixels to each other. We do this by matching the closest pixels from each image. 
