...
## 1. Request Parameters  
    ...
    Date Completed:** 2021-07-07T19:34:37.963738  

    Id: c256fa3a-9ca1-4612-86f8-716683586336  
    ...
    Details:  
        ...
        Coordinates:  
            ...
            WBAN23155, 35.4344, -119.0542  
            WBAN23149, 36.02944, -119.0625  
            WBAN93144, 36.31667, -119.4  
            WBAN23110, 36.33333, -119.95  
            WBAN53119, 36.31889, -119.62889  
            WBAN93193, 36.78, -119.7194  
            WBAN93242, 36.98778, -120.11056  
            WBAN23203, 37.38333, -120.56667  
            WBAN93243, 37.2381, -120.8825  
            WBAN23257, 37.28472, -120.51278  
            WBAN23258, 37.6241, -120.9505  
            WBAN23237, 37.8891, -121.2258  
    
    Version: This request was processed by AppEEARS version 2.61  

## 2. Request File Listing  

- Comma-separated values file with data extracted for a specific product
  - SJ-NOAA-ECO-ECO2LSTE-001-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - SJ-NOAA-ECO-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - SJ-NOAA-ECO-request.json
- xml file
  - SJ-NOAA-ECO-ECO2LSTE-001-metadata.xml  
...
- Hook, S., Hulley, G. (2019). ECOSTRESS Land Surface Temperature and Emissivity Daily L2 Global 70 m V001. NASA EOSDIS Land Processes DAAC. Accessed 2021-07-08 from https://doi.org/10.5067/ECOSTRESS/ECO2LSTE.001. Accessed July 7, 2021.

## 9. Software Citation  

AppEEARS Team. (2021). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 2.60. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed July 7, 2021. https://lpdaacsvc.cr.usgs.gov/appeears
