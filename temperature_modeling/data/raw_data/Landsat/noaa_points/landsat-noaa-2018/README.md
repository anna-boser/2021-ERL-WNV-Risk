...
## 1. Request Parameters  
    ...
    Name: landsat NOAA 2018  

    Date Completed:** 2021-07-08T17:04:29.966497  

    Id: 9909bd38-9f00-4669-a169-1d1a6c17b0a4  
...
- Comma-separated values file with data extracted for a specific product
  - landsat-NOAA-2018-CU-LC08-001-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - landsat-NOAA-2018-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - landsat-NOAA-2018-request.json
- xml file
  - landsat-NOAA-2018-CU-LC08-001-metadata.xml  
...
AppEEARS Team. (2021). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 2.60. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed July 8, 2021. https://lpdaacsvc.cr.usgs.gov/appeears
