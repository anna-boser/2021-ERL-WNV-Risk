...
## 1. Request Parameters  
    ...
    Name: landsat NOAA 2019  

    Date Completed:** 2021-07-08T17:03:41.501913  

    Id: 721de4c6-a966-4a46-bb12-d0f7da67adf3  
...
- Comma-separated values file with data extracted for a specific product
  - landsat-NOAA-2019-CU-LC08-001-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - landsat-NOAA-2019-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - landsat-NOAA-2019-request.json
- xml file
  - landsat-NOAA-2019-CU-LC08-001-metadata.xml  
